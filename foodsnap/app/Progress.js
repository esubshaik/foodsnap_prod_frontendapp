  ...
  return (
    <View style={[t.flex,t.flexRow,t.justifyBetween,t.m2]}>
      <View style={[t.flex,t.flexCol]}>
        <Text style={[t.textOrange800,t.textLg,t.fontSemibold,t.pB2,t.pT1]}> Your Progress</Text>
      <View style={styles.container}>
        {numberOfOnes ? firstRow.map((day, index) => (
          <View key={index} style={[styles.circle, day === 1 ? styles.circleFilled : null]} />
        )): <View>
          <Text style={[t.textOrange800,t.textBase,t.pT2,t.fontSemibold]}>Log ur' meal to continue your Streak 🔥</Text>
          </View>
          }
      </View>
      <View style={styles.container}>
      ...
      <View style={[t.flex1,t.mT6,t.mL4]}>
        <Text style={[t.textOrange800,t.text3xl,t.fontSemibold]}>{percent ?percent+'%' : null}</Text>
      </View>
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  circleFilled: {
    backgroundColor: '#9a3412', // or any color you prefer
  },
});
